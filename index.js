...
//connect mongodb
mongoose.connect('mongodb+srv://'+process.env.USER_N+':'+process.env.USER_P+'@cluster0-ngaul.mongodb.net/test?retryWrites=true&w=majority', { useNewUrlParser: true, useUnifiedTopology: true  });
...
app.get('/', function (req,res) {//load home page
    res.render('maker.ejs',{isAuthenticated:res.locals.isAuthenticated,style:'<link class="style" href="style.css" rel="stylesheet" type="text/css" /><link  href="styleHoPop.css" rel="stylesheet" type="text/css" /><link href="styleHo.css" rel="stylesheet" type="text/css" /><link  href="styleHoWr.css" rel="stylesheet" type="text/css" />'});
});
...
app.get('/signUp',authenticationMiddleware(), function (req,res) {//load sign manager page
    ...
    res.render('signUp.ejs',{style:'<link class="style" href="style.css" rel="stylesheet" type="text/css" /><link class="styleLI" href="styleLI.css" rel="stylesheet" type="text/css">'});
});
...
passport.serializeUser(function(co, done) {
 ...
 app.get('/login-manager',function(req,res){
    res.render('loginM.ejs',{style:'<link class="style" href="style.css" rel="stylesheet" type="text/css" /><link class="styleLI" href="styleLI.css" rel="stylesheet" type="text/css">'});
...
app.use('/manager',authenticationMiddleware(),  (req,res) => {//load manager home page need chek
        res.render('manager.ejs',{style:'<link class="style" href="style.css" rel="stylesheet" type="text/css" />'});
});
...
app.get('/movies', function (req, res) {//load movies page
        ...
        // } else {
            res.render('movies.ejs',{style:'<link class="style" href="style.css" rel="stylesheet" type="text/css"><link class="styleM" href="styleM.css" rel="stylesheet" type="text/css">'});
        // }
...
app.get('/newMovie',authenticationMiddleware(), function (req, res) {//load new movie page
    res.render('newMovie.ejs',{style:'<link class="style" href="style.css" rel="stylesheet" type="text/css"><link class="styleFrm" href="styleFrm.css" rel="stylesheet" type="text/css"><link class="styleNM" href="styleNM.css" rel="stylesheet" type="text/css">'});
});
...
res.render('stages.ejs',{style:'<link class="style" href="style.css" rel="stylesheet" type="text/css"><link class="styleFrm" href="styleFrm.css" rel="stylesheet" type="text/css">'});
});
...
app.post('/calendar/add',authenticationMiddleware(), function (req, res) {//add time schdoual
    ...
    app.delete('/calendar/delete',authenticationMiddleware(), function (req, res) {//delete time schdoual
        let deldata=req.query;
        TimeS = mongoose.model("nTime", ntimeSchem);
        console.log( {date: deldata.date,hour: deldata.time,movie: deldata.movie,stage: deldata.stage});

        TimeS.findOneAndDelete({date : deldata.date, hour : deldata.time, movie : deldata.movie, stage : deldata.stage}, 
            function (error, delres) {
                console.log(delres);
                if (error) {
                  res.send('error adding stage');
    ...
    res.render('moviesToStage.ejs',{style:'<link class="style" href="style.css" rel="stylesheet" type="text/css" /><link class="calenderStyle" href="calenderStyle.css" rel="stylesheet" type="text/css"><link class="styleFrm" href="styleFrm.css" rel="stylesheet" type="text/css"><script src="https://kit.fontawesome.com/349d43e1dd.js"></script>'});
    });
...
app.get('/*', function (req, res) {//load err page
    res.render('errPage.ejs',{style:'<link class="style" href="style.css" rel="stylesheet" type="text/css">'});
});
